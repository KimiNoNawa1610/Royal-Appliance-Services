        ...
        <Image style={styles.image} source={require("../assets/royal.png")} />
            <View style= {styles.space}>
                ...
                <Pressable onPress = {()=>navigation.navigate("Login")} >
                    <Text style = {styles.text}> <Image style={styles.icon} source = {require("../assets/calendar.png")}/>Calendar </Text>
                </Pressable>
                </View>
                ...
                <View style = {styles.press}>
                    <Pressable onPress = {()=>navigation.navigate("EmployeeGenerator")} >
